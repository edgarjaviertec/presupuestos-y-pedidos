...
<div id="pageContent" class="d-none">
	<h1 class="page-heading h3 mb-3 ">
		...
		<div>
			<button type="button" class="btn btn-lg btn-secondary  align-items-center" data-toggle="modal"
	...
	<div class="modal fade" id="generateReportModal" tabindex="-1">
		<div class="modal-dialog modal-dialog-scrollable">
			<div class="modal-content">
				<form target="_blank" action="<?php echo base_url('admin/estimates/generate_pdf_report') ?>"
					  method="get">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<div class="custom-control custom-radio">
								<input type="radio" id="customRadio1" name="report_type" class="custom-control-input"
									   checked value="estimates">
								<label class="custom-control-label" for="customRadio1">Lista de presupuestos</label>
							</div>
							<div class="custom-control custom-radio">
								<input type="radio" id="customRadio2" name="report_type" class="custom-control-input"
									   value="estimates_by_customers">
								<label class="custom-control-label" for="customRadio2">Lista de presupuestos por
									cliente</label>
							</div>
						</div>
						<div class="form-group">
							...
							<select class="custom-select" name="month">
								...
								<option value="2" <?php echo(intval(date("m")) == 2 ? 'selected' : '') ?>>Febrero
								</option>
								...
								<option value="8" <?php echo(intval(date("m")) == 8 ? 'selected' : '') ?>>Agosto
								</option>
								<option value="9" <?php echo(intval(date("m")) == 9 ? 'selected' : '') ?>>Septiembre
								</option>
								<option value="10" <?php echo(intval(date("m")) == 10 ? 'selected' : '') ?>>Octubre
								</option>
